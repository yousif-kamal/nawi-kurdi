...
class KurdishNames {
  ...
  factory KurdishNames.fromJson(String source) =>
      KurdishNames.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() => 'KurdishNames(names: $names, recordCount: $recordCount)';

  @override
  bool operator ==(covariant KurdishNames other) {
    if (identical(this, other)) return true;

    return listEquals(other.names, names) && other.recordCount == recordCount;
  }
